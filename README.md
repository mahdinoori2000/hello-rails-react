...
```bash
  git clone https://github.com/mahdinoori2000/hello-rails-react.git
```
...
Feel free to check the [issues page](https://github.com/mahdinoori2000/hello-rails-react/issues).
